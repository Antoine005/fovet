...
Export:
  ...
  - ard_autoencoder_model.h (optional) -- C byte-array for TFLite Micro
...
class AutoEncoderDetector(Detector):
    ...
    def fit(self, dataset: Dataset) -> None:
        ...
        self._model = keras.Model(inputs, decoded, name="ard_autoencoder")
    ...
    def export(
        ...
        **_kwargs,
        ...
        Writes:
          ...
          - ``ard_autoencoder_model.h`` -- C byte-array (TFLite Micro)
        ...
        # --- ard_autoencoder_model.h -----------------------------------
        header_path = output_dir / "ard_autoencoder_model.h"
