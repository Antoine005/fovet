...
Export:
  ...
  - ard_lstm_autoencoder_model.h -- C byte-array for TFLite Micro
...
class LSTMAutoEncoderDetector(Detector):
    ...
    def fit(self, dataset: Dataset) -> None:
        ...
        self._model = keras.Model(inputs, outputs, name="ard_lstm_autoencoder")
    ...
    def export(
        ...
        **_kwargs,
        ...
        Writes:
          ...
          - ``ard_lstm_autoencoder_model.h`` -- C byte-array (TFLite Micro)
        ...
        # --- ard_lstm_autoencoder_model.h ------------------------------
        header_path = output_dir / "ard_lstm_autoencoder_model.h"
    ...
    def _generate_c_header(self, tflite_bytes: bytes) -> str:
        ...
        guard = "ARD_LSTM_AUTOENCODER_MODEL_H"
        ...
        return (
            ...
            " *\n"
            " * Auto-generated by Ardent Forge -- do not edit manually.\n"
