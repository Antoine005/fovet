...
echo ==============================================
echo   Ardent Watch -- Demarrage de l'environnement
echo ==============================================
...
if %errorlevel%==0 (
    ...
    start "Mosquitto" /B "C:\Program Files\Mosquitto\mosquitto.exe" -c "D:\fovet\mosquitto\mosquitto.conf"
...
if exist "D:\fovet\platform-dashboard\" (
    start "VIGIE" cmd /k "cd /d D:\fovet\platform-dashboard && pnpm dev"
